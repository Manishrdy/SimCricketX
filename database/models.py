...
class MasterPlayer(db.Model):
    ...
    # T20 ratings retain the original column names for backwards compatibility.
    ...
    # Format-specific pool defaults copied into a squad's Player snapshot.
    list_a_batting_rating = db.Column(db.Integer, default=50)
    list_a_bowling_rating = db.Column(db.Integer, default=50)
    list_a_fielding_rating = db.Column(db.Integer, default=50)
    fc_batting_rating = db.Column(db.Integer, default=50)
    fc_bowling_rating = db.Column(db.Integer, default=50)
    fc_fielding_rating = db.Column(db.Integer, default=50)
    fc_technique_rating = db.Column(db.Integer, default=50)
    fc_temperament_rating = db.Column(db.Integer, default=50)
    fc_stamina_rating = db.Column(db.Integer, default=50)
    batting_hand = db.Column(db.String(20))
    bowling_type = db.Column(db.String(50))
    bowling_hand = db.Column(db.String(20))
    is_captain = db.Column(db.Boolean, default=False)
...
class UserPlayer(db.Model):
    ...
    bowling_rating = db.Column(db.Integer, default=50)
    fielding_rating = db.Column(db.Integer, default=50)
    # Complete per-user override/custom rating profile for every match format.
    list_a_batting_rating = db.Column(db.Integer, default=50)
    list_a_bowling_rating = db.Column(db.Integer, default=50)
    list_a_fielding_rating = db.Column(db.Integer, default=50)
    fc_batting_rating = db.Column(db.Integer, default=50)
...
class TournamentTeam(db.Model):
    ...
    drawn = db.Column(db.Integer, default=0, nullable=False)  # First-Class (FC) only
